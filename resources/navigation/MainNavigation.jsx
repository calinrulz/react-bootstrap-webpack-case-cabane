        ...
        <div className="container nav-container">
          <div className="navbar-header">
            ...
            <a className="navbar-brand" href="#">
              <img src="./img/logo.png" width="60" alt="React Case &amp; Cabane" />
            </a>
          </div>
          ...
          <div className="case-extra-nav-container">
            <ul className="extra-links">
              <li className="">
                <span className="glyphicon glyphicon-chevron-right glyphicon-right-arrow" area-hidden="true"></span>
                <a href="#">Despre Noi</a>
              </li>
              ...
              <li className="case-nav-phone">
                <span className="glyphicon glyphicon-phone glyphicon-right-arrow" area-hidden="true"></span>
            ...
            <form className="case-navbar-search">
              <div className="form-group">
                ...
                <span className="glyphicon glyphicon-search case-glyphicon-search" area-hidden="true"></span>
              </div>
            </form>
          </div>
